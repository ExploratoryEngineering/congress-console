export { GravatarServiceMock } from "./services/GravatarService.mock";
...
export { DialogControllerMock } from "./vendor/DialogController.mock";
export { RouterMock } from "./vendor/Router.mock";
export { SignalerMock } from "./vendor/Signaler.mock";
