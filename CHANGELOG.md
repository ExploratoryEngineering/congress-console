...
* **datamapperdialog:** fix select labels ([b773b72](https://github.com/ExploratoryEngineering/congress-console/commit/b773b72))
...
* **rolling-graphs:** implement rolling graphs correctly ([8ffb9a9](https://github.com/ExploratoryEngineering/congress-console/commit/8ffb9a9))
...
* **range-chooser:** make range chooser keyboard friendly ([fe9f955](https://github.com/ExploratoryEngineering/congress-console/commit/fe9f955))
...
* **landingpage:** add initial commit for landing page ([a0e9b64](https://ghe.telenordigital.com/per-kristian-kummermo/ee-lora-self-service-portal/commits/a0e9b64))
...
* **application-card:** bypass routing event. Fixes #133 ([4038f9c](https://ghe.telenordigital.com/per-kristian-kummermo/ee-lora-self-service-portal/commits/4038f9c)), closes [#133](https://ghe.telenordigital.com/per-kristian-kummermo/ee-lora-self-service-portal/issues/133)


### Features

* **pushState:** activate push state. Fixes #96 ([d0f7dcf](https://ghe.telenordigital.com/per-kristian-kummermo/ee-lora-self-service-portal/commits/d0f7dcf)), closes [#96](https://ghe.telenordigital.com/per-kristian-kummermo/ee-lora-self-service-portal/issues/96)
...
* **applications:** use response from server when creating new app ([b89d389](https://ghe.telenordigital.com/per-kristian-kummermo/lora.exploratory.engineering/commits/b89d389))
